...
def main():
    ...
    text_conditions = [
        ...
        (
            "full",
            "A cartoon house with a red roof on a green hill under a blue sky with yellow sun",
        ),  # Full detail
    ...
    for name, text in text_conditions:
        ...
        print(
            f"  Shape: {result.embeddings.shape}, std: {result.scaled_std:.2f}, scale: {result.scale_factor:.2f}"
        )
