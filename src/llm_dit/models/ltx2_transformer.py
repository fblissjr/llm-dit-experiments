...
Usage:
    from llm_dit.models.ltx2_transformer import LTX2Transformer, LTXModelType
...
from llm_dit.models.ltx2_attention import Attention, AttentionCallable, AttentionFunction
...
class LTX2Transformer(nn.Module):
    ...
    - 48 transformer blocks
    - 32 attention heads × 128 head_dim = 4096 inner dim
