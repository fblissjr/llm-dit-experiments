# GGUF dequantization kernels for LLM-DiT.
#
# Pure PyTorch implementations of GGML quantization format dequantization.
# Ported from ComfyUI-GGUF (City96, Apache-2.0).
#
# Supports: Q2_K through Q8_0, IQ4_NL, IQ4_XS, BF16, F16, F32.
# Each function takes raw byte blocks and returns dequantized float tensors.
...
def dequantize_tensor(tensor, dtype=None, dequant_dtype=None):
    """Dequantize a GGMLTensor to the target dtype.

    Args:
        tensor: GGMLTensor (or plain tensor) to dequantize.
        dtype: Target output dtype.
        dequant_dtype: Intermediate dtype for dequantization. "target" uses dtype.
    """
...
def dequantize(data, qtype, oshape, dtype=None):
    """Dequantize raw byte data back to usable shape/dtype."""
